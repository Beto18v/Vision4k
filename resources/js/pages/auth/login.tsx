                        ...
                        <div className="mt-6">
                            ...
                            <div className="mt-6">
                                <a
                                    ...
                                    className="flex items-center justify-center rounded-xl border border-white/20 bg-white/5 px-4 py-3 transition-colors hover:bg-white/10"
                                >
                                ...
                                {/* Facebook login commented out - requires Facebook Developer account verification */}
                                {/* <a
